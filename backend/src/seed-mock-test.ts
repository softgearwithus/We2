...
import { MockTestQuestion, MockQuestionType } from './users/../test-series/entities/mock-test-question.entity';
...
async function run() {
    ...
    const mockTest = testRepo.create({
        ...
        description: 'This is a sample dummy test created by Emble AI for you to test the new simulation dashboard.',
    ...
    const qData = [
        ...
        {
            type: MockQuestionType.TEXT,
            question: "Write an SQL query to find the 2nd highest salary from an Employee table.",
            correctAnswer: "",
            marks: 5
        }
    ];

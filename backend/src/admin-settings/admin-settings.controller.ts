...
export class AdminSettingsController {
    ...
    @ApiOperation({ summary: 'Get update flags for dashboard indicators (Admin)' })
    ...
    @Public()
    @Get('public/updates')
    @ApiOperation({ summary: 'Get update flags for dashboard indicators (Public)' })
    ...
    async updateSecurity(@Request() req: any, @Body() dto: UpdateAdminSecurityDto) {

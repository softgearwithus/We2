...
export class CollegesController {
    ...
    async updateCollege(@Param('id') id: string, @Body() payload: UpdateCollegeDto) {
    ...
    async addStaff(@Request() req: any, @Param('id') id: string, @Body() payload: CreateStaffDto) {
        this.enforceCollegeAccess(req, id);
    ...
    async removeStaff(@Request() req: any, @Param('id') id: string, @Param('staffId') staffId: string) {
        this.enforceCollegeAccess(req, id);
    ...
    async createCohort(@Request() req: any, @Param('id') id: string, @Body() payload: CreateCohortDto) {
        this.enforceCollegeAccess(req, id);
    ...
    async exportCohort(
        ...
        res.setHeader('Content-Disposition', `attachment; filename="${cohort.code}_students.csv"`);
        res.send(csvContent);
    }

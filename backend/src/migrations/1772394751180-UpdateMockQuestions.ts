...
export class UpdateMockQuestions1772394751180 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "mock_test_results" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "start_time" TIMESTAMP NOT NULL, "end_time" TIMESTAMP, "total_marks" integer NOT NULL DEFAULT '0', "marks_obtained" numeric(5,2) NOT NULL DEFAULT '0', "is_evaluated" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid, "mock_test_id" uuid, CONSTRAINT "PK_59cc7096430ef5b184246c8f272" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "mock_test_student_responses" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "time_spent_seconds" integer NOT NULL DEFAULT '0', "response_value" text, "is_correct" boolean, "marks_awarded" numeric(5,2) NOT NULL DEFAULT '0', "ai_feedback" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "mock_test_result_id" uuid, "question_id" uuid, CONSTRAINT "PK_0ad5ca114b646932f742327f4d4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "mock_test_questions" ADD "solutionText" text`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."mock_test_questions_questiontype_enum" RENAME TO "mock_test_questions_questiontype_enum_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."mock_test_questions_questiontype_enum" AS ENUM('SINGLE_CORRECT', 'MULTI_CORRECT', 'TEXT', 'CODE')`,
    );
    await queryRunner.query(
      `ALTER TABLE "mock_test_questions" ALTER COLUMN "questionType" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "mock_test_questions" ALTER COLUMN "questionType" TYPE "public"."mock_test_questions_questiontype_enum" USING (CASE WHEN "questionType"::text = 'MCQ' THEN 'SINGLE_CORRECT' ELSE "questionType"::text END)::"public"."mock_test_questions_questiontype_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "mock_test_questions" ALTER COLUMN "questionType" SET DEFAULT 'SINGLE_CORRECT'`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."mock_test_questions_questiontype_enum_old"`,
    );
    await queryRunner.query(
      `ALTER TABLE "mock_test_questions" DROP COLUMN "correctAnswer"`,
    );
    await queryRunner.query(
      `ALTER TABLE "mock_test_questions" ADD "correctAnswer" text`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "mock_test_results" ADD CONSTRAINT "FK_db756e7e576966fd576d1886019" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "mock_test_student_responses" ADD CONSTRAINT "FK_a7221cac2677710d3798bd4dc80" FOREIGN KEY ("mock_test_result_id") REFERENCES "mock_test_results"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(

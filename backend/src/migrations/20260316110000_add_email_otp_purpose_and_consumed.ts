...
export class AddEmailOtpPurposeAndConsumed20260316110000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_email_otp_email_purpose_unique";`);
        await queryRunner.query(`ALTER TABLE "email_otp" DROP COLUMN IF EXISTS "consumedAt";`);
        await queryRunner.query(`ALTER TABLE "email_otp" DROP COLUMN IF EXISTS "purpose";`);
    }
}

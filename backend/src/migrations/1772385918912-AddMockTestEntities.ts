...
export class AddMockTestEntities1772385918912 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "mock_tests" DROP CONSTRAINT "FK_05928b41c2a71b22d2bf6ac2aca"`,
    );
    await queryRunner.query(
      `ALTER TABLE "mock_test_sections" DROP CONSTRAINT "FK_52da1b9e921610e4b7769f2042e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "mock_test_questions" DROP CONSTRAINT "FK_78406b54dbc4da337e708893f6c"`,
    );

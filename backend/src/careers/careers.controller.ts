...
export class CareersController {
    ...
    @ApiResponse({ status: 201, description: 'The career has been successfully created.' })
    ...
    @ApiResponse({ status: 200, description: 'The career has been successfully updated.' })
    ...
    @ApiResponse({ status: 200, description: 'The career has been successfully deleted.' })

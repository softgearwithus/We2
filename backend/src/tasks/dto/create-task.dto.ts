...
import { TaskType, TaskPriority, TaskDifficulty } from '../entities/task.entity';
...
export class CreateTaskDto {
    ...
    @ApiProperty({
        example: 'Users are unable to login with correct credentials. Debug and fix the issue.',

...
import { Simulation, SimulationStatus } from '../simulations/entities/simulation.entity';
...
export class TasksService {
    ...
    async create(
        ...
        if (simulation.status !== SimulationStatus.IN_PROGRESS) {
            throw new BadRequestException(
                'Cannot add tasks to inactive simulations',
            );
        }
     ...
     */
    async findBySimulation(simulationId: string, userId: string): Promise<Task[]> {
    ...
    async update(
        ...
        if (
            ...
            throw new BadRequestException(
                'Cannot update completed or failed tasks',
            );
        }

                ...
                <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-7 bg-white rounded-[2rem] p-8 md:p-10 border border-slate-200 shadow-premium relative overflow-hidden">
                        ...
                        <div className="space-y-8">
                            <div className="flex gap-5">
                                ...
                                <div>
                                    ...
                                    <div className="text-slate-500 mt-1.5 leading-relaxed font-medium">We'll serve you the most important SQL questions you need to review based on your past performance using our <span className="font-bold text-indigo-600 bg-indigo-50 px-1.5 rounded">adaptive algorithm</span>.</div>
                                </div>
                            </div>
                            <div className="flex gap-5">
                                ...
                                <div>
                                    ...
                                    <div className="text-slate-500 mt-1.5 leading-relaxed font-medium">There is <span className="font-bold text-rose-500 bg-rose-50 px-1.5 rounded">no Run button</span>. You must mentally execute and reason through your queries before submitting, just like a real whiteboard interview.</div>
                                </div>
                            </div>
                            <div className="flex gap-5">
                        ...
                        <div className="mt-10 pt-8 border-t border-slate-100 bg-slate-50 -mx-8 md:-mx-10 -mb-8 md:-mb-10 p-8 md:p-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            <div>
                                <div className="font-bold text-slate-900 mb-1 text-lg">Want to choose queries?</div>
                                <div className="text-sm text-slate-500 font-medium">Practice specific topics at your own pace.</div>
                            </div>
                            <Link href="/dashboard/sql/all" className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white border border-slate-200 text-sm font-bold text-slate-700 hover:text-brand-orange hover:border-brand-orange hover:shadow-[0_8px_30px_rgb(249,115,22,0.12)] transition-all rounded-xl whitespace-nowrap">

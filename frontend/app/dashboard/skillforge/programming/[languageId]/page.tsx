    ...
    if (chapters.length === 0) {
        return (
            <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 text-center">
                ...
                <h2 className="text-2xl font-bold text-slate-800 mb-2">Course Content Not Found</h2>
            ...
            <div className="bg-slate-900 pt-20 pb-24 px-6 lg:px-10 relative overflow-hidden">
                ...
                <div className="max-w-full max-w-[1200px] mx-auto relative z-10">
                    ...
                    <p className="text-xl text-slate-300 max-w-2xl leading-relaxed">
                        A structured path from beginner to expert. Master syntax, data structures, and algorithms with hands-on practice.
                    </p>
                ...
                <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-8">
                    ...
                    <div className="space-y-4">
                        {chapters.map((chapter, index) => (
                            <Link href={`/dashboard/skillforge/programming/${languageId}/${chapter.id}`} key={chapter.id} className="block group">
                                <motion.div

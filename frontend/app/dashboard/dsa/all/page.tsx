        ...
        <>
                                        ...
                                        <div className="px-3 py-4">
                                            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 rounded-2xl border border-orange-100 bg-gradient-to-r from-orange-50 via-white to-white px-5 py-4 shadow-lg">
                                                <div>
                                                    ...
                                                    <div className="text-lg font-black text-slate-900">You unlocked 3 free DSA questions.</div>
                                                    <div className="text-xs text-slate-500 font-medium">Go Standard or Pro to open the full DSA vault + mastery tracking.</div>
                                                </div>
                                                <button
            ...
            >
                ...
                >
                    ...
                    <h3 className="text-3xl font-black text-slate-900 mb-3">Unlock the full DSA problem bank</h3>
                    <p className="text-slate-600 font-medium mb-6">
                        You have a 3-question preview. Upgrade to Standard or Pro to access every question, company patterns, and mastery tracking.
                    </p>

...
const comparisonData = [
    { feature: "Scope", typical: "Isolated DSA or Dev Course", emble: "Full Stack Placement Ecosystem" },
    { feature: "Experience", typical: "Toy Projects / Capstones", emble: "Real-world Job Simulation" },
    { feature: "Interview Prep", typical: "Limited Peer Mocks", emble: "Unlimited AI Video Analysis" },
    { feature: "Resume", typical: "Generic PDF Templates", emble: "ATS Scorer & Builder" },
    { feature: "Relevance", typical: "Static Syllabus", emble: "Live AI Trends & News" },
];
            ...
            <div className="max-w-5xl mx-auto px-6">
                ...
                <div className="mt-12 p-6 bg-purple-50 rounded-2xl border border-purple-100 flex flex-col sm:flex-row items-center justify-between gap-6">
                    <div className="text-purple-900 font-medium">
                        Emble graduates are <strong>3.5x more likely</strong> to pass technical screening due to their documented work history.
                    </div>

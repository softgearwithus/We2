            ...
            <div className="max-w-[1000px] mx-auto px-6">
                <div className="text-center mb-16 md:mb-24 max-w-3xl mx-auto">
                    <h2 className="text-[2.5rem] md:text-[4rem] font-[800] tracking-tighter text-[#202b20] mb-6">
                        Why We Are <span className="text-[#202b20] font-[500] tracking-tight bg-[#ffa116] px-3 border-2 border-[#202b20] shadow-[2px_2px_0_0_#202b20]">Better</span>
                    </h2>
                ...
                <div className="rounded-none border-2 border-[#202b20] shadow-[2px_2px_0_0_#202b20] bg-white overflow-x-auto w-full">
                ...
                <div className="mt-12 p-6 bg-[#efeff1] rounded-none border-2 border-[#202b20] shadow-[2px_2px_0_0_#202b20] flex flex-col md:flex-row items-center justify-between gap-6">

        ...
        <section className="py-20 relative overflow-hidden bg-white">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    >
                        {/* Glow effect */}
                        <div className="absolute -top-20 -right-20 w-80 h-80 bg-emerald-50 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none transform-gpu will-change-opacity" style={{ filter: 'blur(30px)' }} />
                    ...
                    >
                        {/* Glow effects */}
                        <div className="absolute -top-20 -right-20 w-80 h-80 bg-brand-orange/10 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none transform-gpu will-change-opacity" style={{ filter: 'blur(30px)' }} />

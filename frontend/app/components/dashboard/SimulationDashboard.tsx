    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <button
                    className="bg-slate-800 hover:bg-slate-900 text-white px-6 py-2.5 rounded-xl font-bold transition-all shadow-lg shadow-slate-200 flex items-center gap-2"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    { label: 'Sprint Velocity', value: '24 pts', sub: '+12% vs last sprint', icon: 'speed', color: 'text-slate-700', bg: 'bg-slate-50' },
                    { label: 'Active Tickets', value: '8', sub: '3 High Priority', icon: 'confirmation_number', color: 'text-blue-500', bg: 'bg-blue-50' },
                    { label: 'PRs Merged', value: '14', sub: 'Code Quality: A+', icon: 'merge_type', color: 'text-slate-500', bg: 'bg-slate-50' },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <button className="text-sm text-slate-800 font-bold hover:underline">View Board</button>
                    </div>
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <div className="bg-slate-50 p-3 rounded-xl">
                            <div className="text-xs font-bold text-slate-400 uppercase mb-3 flex items-center gap-2">
                                <span className="w-2 h-2 rounded-full bg-slate-400 animate-pulse"></span> In Progress
                            </div>
                            <div className="bg-white p-3 rounded-lg shadow-sm border border-slate-200 mb-2">
                                <span className="text-xs font-semibold text-slate-700 tracking-wide">SMP-99</span>
                                ...
                                <div className="flex items-center gap-2 mt-2">
                                    ...
                                    <div className="w-5 h-5 rounded-full bg-slate-100 text-slate-800 text-[10px] flex items-center justify-center font-bold">AM</div>
                                </div>
                            </div>
                        </div>
                        <div className="bg-slate-50 p-3 rounded-xl">
                ...
                <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
                    ...
                    <button className="w-full mt-6 py-3 rounded-xl border-2 border-slate-100 text-sm font-bold text-slate-600 hover:border-slate-800 hover:text-slate-800 transition-all">
                        View All PRs
                    </button>
                </div>
            </div>

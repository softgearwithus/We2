...
const successStories = [
    {
        ...
        quote: "The mock interviews on Emble were incredibly realistic. I converted my internship at Google into a full-time role thanks to the system design modules.",
    ...
    },
    {
        ...
        path: "Emble Simulation",
        image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=200&h=200&auto=format&fit=crop",
        quote: "Emble's 21-day simulation taught me more about professional Git workflows and JIRA than my previous job did in a year.",
    ...
    },
    {
        ...
        quote: "Coming from a tier-3 college, I always felt the gap. Emble gave me the same level of preparation as IITians. I landed Microsoft off-campus!",
        tags: ["MNC", "Off-Campus"],
        hike: "MAANG"
    },
    {
    ...
    },
    {
        ...
        quote: "The infrastructure simulation at Emble, specifically the Kubernetes modules, was exactly what Adobe was looking for in my technical round.",
            ...
            <section className="py-12 border-y border-gray-100 sticky top-16 bg-white/80 backdrop-blur-md z-40">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex flex-wrap items-center justify-center gap-3">
                        {['All', 'Bootcamp', 'Simulation', 'FAANG', 'MNC', 'Transition'].map((tag) => (
                            <button
                                key={tag}

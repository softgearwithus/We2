...
const services = [
    ...
    { name: "Emble Simulation Engine", status: "operational", uptime: "99.95%", icon: Zap },
    { name: "Emble AI Mentors", status: "operational", uptime: "99.99%", icon: Activity },
...
const changelog = [
    {
        ...
        items: [
            ...
            "Updated all landing pages (Bootcamp, Simulation) with premium aesthetics.",
    ...
    },
    {
        ...
        version: "v2.0.0",
        type: "Release",
        title: "The Emble Simulation Engine",

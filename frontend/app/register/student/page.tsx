            ...
            visual={
                <div className="space-y-6">
                    <div className="bg-white/10 p-5 rounded-2xl backdrop-blur-sm border border-white/10 relative overflow-hidden">
                        ...
                        <div className="text-[10px] font-black uppercase tracking-widest text-indigo-300 mb-2 flex items-center gap-2">
                            <Rocket size={12} />
                        ...
                        <div className="flex -space-x-3 mb-4">
                            {[1, 2, 3, 4].map((i) => (
                                <div key={i} className="w-9 h-9 rounded-full bg-gradient-to-br from-indigo-400 to-indigo-600 border-2 border-indigo-900/50 text-xs flex items-center justify-center font-bold shadow-lg">
                                    <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${i}`} alt="user" className="w-full h-full rounded-full" />
                                </div>
                            ))}
                            <div className="w-9 h-9 rounded-full bg-white text-indigo-600 border-2 border-indigo-900/50 text-[10px] flex items-center justify-center font-black shadow-lg">
                                +40
                            </div>
                        </div>

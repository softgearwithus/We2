        ...
        <main className="min-h-screen bg-white">
            ...
            <section className="relative pt-32 pb-20 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
                    ...
                    >
                        We founded We2 with a simple yet ambitious goal: to ensure that every talented individual has a direct pathway to their dream career, regardless of where they start.
                    </motion.p>
                </div>
            </section>
